---
name: bootstrap
description: Adapt this ANEW workspace to the current project (new or existing) through a short interview. Use when AGENTS.md still says "NOT CONFIGURED", or the user asks to bootstrap, set up, or initialize the workspace.
---
