---
description: Something went wrong — pick and run the right recovery ramp (R-01…R-13)
argument-hint: what happened
---
Read prompts/recovery/README.md. Based on what happened — "$ARGUMENTS" — identify the matching
ramp (R-01…R-13) yourself or via the `planner` subagent (diagnosis is planner-tier judgment, see
